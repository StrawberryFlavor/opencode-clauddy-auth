...
export type ClauddyProviderSettings = {
  apiKey?: string
  baseURL?: string
...
export interface ClauddyProvider {
...
export function createClauddy(options: ClauddyProviderSettings = {}): ClauddyProvider {
  ...
  const provider = ((modelId: string) => createModel(modelId)) as ClauddyProvider
...
export const clauddy = createClauddy()
