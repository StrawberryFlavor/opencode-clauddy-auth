...
const PROVIDER_ID = "clauddy";
const PROVIDER_NAME = "Clauddy";
const PLUGIN_ENTRY = PACKAGE_NAME;
const PROVIDER_NPM = existsSync(new URL("../dist/provider.js", import.meta.url))
  ? new URL("../dist/provider.js", import.meta.url).href
  : new URL("../provider.ts", import.meta.url).href;
const DEFAULT_API = "https://api.openai.com/v1";
const DEFAULT_ENV = ["ANTHROPIC_AUTH_TOKEN", "CLAUDDY_API_KEY"];
